...
#let mocha = get-flavor("mocha").colors
#let latte = get-flavor("latte").colors

#let catppuccin-light = (
  accent-primary: latte.green.rgb,
  accent-secondary: latte.green.rgb.lighten(50%),
  accent-subtle: latte.surface1.rgb,
  accent-glow: latte.green.rgb,
  accent-deep: latte.green.rgb.darken(50%),

  // Background hierarchy
  bg-base: latte.base.rgb,
  bg-elevated: latte.crust.rgb,
  bg-muted: latte.crust.rgb,
  bg-surface: latte.surface0.rgb,
  bg-wash: latte.crust.rgb,

  // Text hierarchy
  text-primary: latte.text.rgb,
  text-secondary: latte.subtext1.rgb,
  text-muted: latte.subtext0.rgb,
  text-light: latte.overlay2.rgb,
  text-subtle: latte.overlay1.rgb,

  // Borders
  border-subtle: latte.overlay0.rgb,
  border-soft: latte.surface1.rgb,
  border-medium: latte.surface1.rgb,
  progress-track: latte.surface1.rgb,

  // Functional colors
  alert-bg: latte.red.rgb.lighten(80%),
  alert-border: latte.red.rgb,
  alert-text: latte.red.rgb,
  example-bg: latte.green.rgb.lighten(80%),
  example-border: latte.green.rgb,
  example-text: latte.green.rgb,

  // Focus slide
  focus-bg: latte.green.rgb,
  focus-text: latte.base.rgb,

  // Standout slide
  standout-bg: latte.green.rgb,
  standout-text: latte.base.rgb,

  // Header bar (Moloch-style)
  header-bg: latte.green.rgb,
  header-text: latte.base.rgb,
)

#let catppuccin-dark = (
  accent-primary: mocha.green.rgb,
  accent-secondary: mocha.green.rgb.lighten(50%),
  accent-subtle: mocha.surface1.rgb,
  accent-glow: mocha.green.rgb,
  accent-deep: mocha.green.rgb.lighten(50%),

  // Background hierarchy
  bg-base: mocha.base.rgb,
  bg-elevated: mocha.mantle.rgb,
  bg-muted: mocha.mantle.rgb,
  bg-surface: mocha.surface0.rgb,
  bg-wash: mocha.mantle.rgb,

  // Text hierarchy
  text-primary: mocha.text.rgb,
  text-secondary: mocha.subtext1.rgb,
  text-muted: mocha.subtext0.rgb,
  text-light: mocha.overlay2.rgb,
  text-subtle: mocha.overlay1.rgb,

  // Borders
  border-subtle: mocha.overlay0.rgb,
  border-soft: mocha.surface1.rgb,
  border-medium: mocha.surface1.rgb,
  progress-track: mocha.surface1.rgb,

  // Functional colors
  alert-bg: mocha.red.rgb.darken(85%),
  alert-border: mocha.red.rgb,
  alert-text: mocha.red.rgb,
  example-bg: mocha.green.rgb.darken(85%),
  example-border: mocha.green.rgb,
  example-text: mocha.green.rgb,

  // Focus slide
  focus-bg: mocha.green.rgb,
  focus-text: mocha.base.rgb,

  // Standout slide
  standout-bg: mocha.green.rgb,
  standout-text: mocha.base.rgb,

  // Header bar (Moloch-style)
  header-bg: mocha.green.rgb,
  header-text: mocha.base.rgb,
)
